    ...
    is_growVoxelTree_canceled(false)
{
    ...
    p_interpolation_tree_future_watcher = new QFutureWatcher<void>(this);
    p_voxel_tree_future_watcher = new QFutureWatcher<void>(this);

    connect(p_interpolation_tree_future_watcher, SIGNAL(finished()), this, SLOT(on_growInterpolationTree_finished()));
    connect(p_interpolation_tree_future_watcher, SIGNAL(canceled()), this, SLOT(on_growInterpolationTree_canceled()));
...
QFutureWatcher<void> *ImageOpenGLWidget::interpolationTreeWatcher()
{
    return p_interpolation_tree_future_watcher;
}
...
void ImageOpenGLWidget::growInterpolationTree()
{
    ...
    while (query.next())
    {
        ...
        p_interpolation_tree_future_list << file;
    }

    // Perform the operation
    p_interpolation_tree_future_watcher->setFuture(QtConcurrent::map(p_interpolation_tree_future_list, &DetectorFile::growInterpolationTree));
}
...
void ImageOpenGLWidget::on_growInterpolationTree_finished()
{
    ...
    else
    {
        ...
        QElapsedTimer t;
        t.start();
        p_interpolation_octree.hierarchy(nodes);
        qDebug() << t.elapsed();
